  ...
  return (
    <div className="relative">
      ...
      <div className="absolute  inset-0  m-auto flex w-full h-full items-center justify-center">
          ...
          <form action={action} className="flex  rounded-md flex-col gap-4 w-full">
            <h2 className="text-center text-2xl font-semibold capitalize">Create account</h2>
            ...
            <button disabled={pending} type="submit" className="text-lg bg-black text-white font-semibold px-2 py-3 rounded-xl cursor-pointer transition-all mt-4 duration-500 ease-in-out hover:bg-white hover:text-black">
              {pending?"signing up ":"Sign Up"}
            </button>
            <div className="text-center">Already have an account?<Link href="/login" className="underline capitalize">login</Link> </div>
          </form>
        </div>
